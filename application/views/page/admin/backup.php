              ...
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  ...
                  <?php endif; ?>
                    ...
                    <a href="<?=base_url('page/admin/backup/pdf'); ?>" class="btn btn-primary">Backup All</a>
                    <a href="<?=base_url('page/admin/backup/format'); ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin memformat semua data?');">Delete All</a>
                  </div>
                </div>
              </div>
            </div>
