                    ...
                    <?php endif; ?>
                        <div class="ml-3 well profile_view">
                          ...
                          <div class=" bottom text-center">
                            ...
                            <div class=" col-sm-6">
                              <a href="<?=base_url('page/admin/profile/edit')?>" class="btn btn-success btn-sm"> <i class="fa fa-user">
                                </i> Edit Profile</a>
                              <a href="<?=base_url('page/admin/profile/gantipassword')?>" class="btn btn-primary btn-sm">
