        ...
        <div class="right_col" role="main">
          ...
          <div class="x_panel">
            <?php if ($this->session->flashdata('pesan')) : ?>
              ...
              <?php endif; ?>
              <form class="form-horizontal form-label-left" action="<?=base_url() .'page/kasmasuk/tambah_aksi'; ?>" method="post">
                <div class="form-group row">
                  <label class="control-label col-md-3" for="first-name">No. Kas Masuk
                  </label>
                  <div class="col-md-7">
                    <input type="text" name="no" readonly="readonly" class="form-control col-md-7" value="<?=$no;?>">
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  <label class="control-label col-md-3" for="last-name">Debit <span class="required">*</span>
                  </label>
                  <div class="col-md-7">
                    <input type="text" name="debit" name="last-name" class="form-control col-md-7" id="nominal">
                    <?= form_error('debit', '<small class="text-danger pl-3">', '</small>'); ?>
                  </div>
                </div>
                <div class="form-group row">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            ...
                            <a href="<?=base_url(); ?>page/kasmasuk/hapus/<?= $row->id_kas; ?>"
          ...
          <h4 class="modal-title" id="myModalLabel">Edit <?=$judul; ?></h4>
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span>
              ...
              <div class="modal-body" id="edit_aksi">
                <form class="form-horizontal form-label-left" action="<?= base_url().'page/kasmasuk/edit_aksi'; ?>" method="post">
                <div class="form-group row">
                ...
                <div class="form-group row">
                  <label class="control-label col-md-4" for="last-name">debit <span class="required">*</span>
                  </label>
                  <div class="col-md-7">
                    <input type="number" name="debit" class="form-control col-md-14" value="" id="debit">
                  </div>
                </div>
                <div class="form-group row">
